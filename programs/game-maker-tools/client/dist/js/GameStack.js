...
var EffectSequence = function () {
        ...
        _createClass(EffectSequence, [{
                ...
                key: 'foldLeft',
                value: function foldLeft() {
                        this.foldLeft = true;
                        return this;
                }
        }, {
                key: 'foldTop',
                value: function foldTop() {
                        this.foldTop = true;
                        return this;
                }
        }, {
                key: 'guiCallback',
                value: function guiCallback(effect, callback) {
                        ...
                        var setValues = function setValues(my_gui) {
                ...
                key: 'get_image_data_array',
                value: function get_image_data_array(sourceImageData, dataListCallback) {
                ...
                key: 'get_canvas_array',
                value: function get_canvas_array(sourceImageData, canvasCallback) {
                ...
                key: 'apply',
                value: function apply(sprite, canvas) {
...
var Motion = function () {
        ...
        _createClass(Motion, [{
                ...
                key: 'getTweenPoints',
                value: function getTweenPoints(size, line, callback) {
...
var Projectile = function () {
        ...
        _createClass(Projectile, [{
                ...
                value: function fire() {
                        ...
                        this.tween = new TWEEN.Tween(this.position).easing().to({ x: this.target.x }).onUpdate(function () {
                                //console.log(objects[0].position.x,objects[0].position.y);
