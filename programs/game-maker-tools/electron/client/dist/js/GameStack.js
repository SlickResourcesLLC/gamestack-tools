                ...
                value: function apply2DFrames() {
                        ...
                        for (var y = this.frameBounds.min.y; y <= this.frameBounds.max.y; y++) {
                                ...
                                for (var _x3 = this.frameBounds.min.x; _x3 <= this.frameBounds.max.x; _x3++) {
                                        ...
                                        var framePos = { x: _x3 * this.frameSize.x + this.frameOffset.x, y: y * this.frameSize.y + this.frameOffset.y };
                ...
                value: function get_image_data_array(sourceImageData, dataListCallback) {
                        ...
                        if (sourceImageData && this.selected_effect.hasOwnProperty('filter')) {
                                ...
                                var tween = new TWEEN.Tween(this.values).to(this.endValues, this.duration).easing(this.curve).onUpdate(function () {
                                        ...
                                        __inst.counter = 0;if (dataListCallback) {
