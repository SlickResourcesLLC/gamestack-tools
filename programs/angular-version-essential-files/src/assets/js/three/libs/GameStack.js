...
var EffectSequence = function () {
        ...
        _createClass(EffectSequence, [{
                ...
                value: function get_image_data_array(sourceImageData, canvasCallback) {
                    ...
                    var canvasList = [];
                        ...
                        if (sourceImageData && this.selected_effect.hasOwnProperty('filter')) {
                            ...
                            if(!this.complete) {
                                ...
                                this.tween = new TWEEN.Tween(this.values).to(this.endValues, this.duration).easing(this.curve).onUpdate(function () {
                                    ...
                                    console.log(jstr([__inst.values, {len:img.data.length}]));
