...
var NestedEventListBuilder = function(instance, allowedTypes, allowedMembers)
{
	...
	return new NestedEventBuilder(this, allowedTypes, allowedMembers);
...
var NestedEventBuilder = function(obj, allowedMembers) {
    ...
    this.refresh = function (obj, ix) {
        ...
        if (obj instanceof NestedEventListBuilder) {
...
NestedEventBuilder.prototype.objectMembers=function()
{
	var object = {};
...
NestedEventBuilder.prototype.createGui=function()
{
    var gui = createGui();
...
NestedEventBuilder.prototype.refreshLists = function()
{


};

NestedEventBuilder.prototype.listSelect = function(gui, obj, members)
{
...
NestedEventBuilder.prototype.renderObjectControllable = function(obj, container, options)
{
   ...
   // DatGui.addEachText(obj, gui);
    ...
    $.each(obj /*This is where our 'MainGame' Object would go*/, function(ix, element_object){
        ...
        if(__inst.listmemberkeys.indexOf(ix) >= 0)
        {
            ...
            if(element instanceof Array ) {
                ...
                html += '<ul class="' + ix + '">' + EventBuilderApp.objectListToUL(ix, element /*INSERT Members of actual array(s)*/, [eye_icon, ""]) + '</ul>';
            ...
            else if(__inst.listmemberkeys.indexOf(ix) >= 0)
            {
                ...
                html += EventBuilderApp.objectListToUL(ix, element /*INSERT Members of objects*/, [eye_icon, ""]) + '</ul>';
    ...
    $.each(obj /*This is where our 'MainGame' Object would go*/, function(ix, element_object){
        ...
        EventBuilderApp.each(relationals, function(ir, item){
        ...
        EventBuilderApp.each(object_watch, function(io, item){
        ...
        if(proceed || element instanceof Array ) {
            ...
            EventBuilderApp.applyControl({parent:$('.' + ix /*The class previously inserted*/), clName:ix, list:element,
        ...
        var arrayListEvents = function(list, clName) {
            ...
            $.each($('.' + clName + ' li'), function (ix, el) {
                ...
                $(el).on('click', function (evt) {
                    ...
                    $('.controllable').find('li').css('color', 'white');
        ...
        var renderListMembers = function(list, clName) {
            ...
            html = EventBuilderApp.objectListToUL(clName, list /*INSERT Members of actual array(s)*/, [eye_icon, ""]) + '</ul>';
