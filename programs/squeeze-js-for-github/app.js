...
require(__dirname + '/static-express.js')(3137, function (err, app) {
    ...
    app.get('/squeeze-api/image?', function(req, res){


        res.end('TODO: complete animation requests');
   ...
   var lokiApi = require(__dirname + '/loki-api.js')(app, function(){

       if(OPEN_APP) {

           var opn = require('opn');

           opn('http://localhost:3137/example/effects-demo.html', {app:"chrome"}) // Opens the url in the default browser
