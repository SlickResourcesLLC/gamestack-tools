    ...
    return[

        {
            ...
            fun:function(){   //test
                ...
                var g =   DatGui.allObjectEventsCheckGui(App.selectedRightClickItem, [Game.sprites[0]], 'Bind Object-Events');
        ...
        {
            name: 'bind_to_controller_events...',
            title: 'bind main-call of item to a controller-event',
            img: 'image/settings_icon.png',
            id:'bind_to_controller_events',
            // disable: true,
            fun:function(){//test

                var g =   DatGui.allControllerEventsCheckGui(App.selectedRightClickItem, [Game.sprites[0]], 'Bind Controller-Events');
...
var __resetRightClicks = function()
{
    ...
    if(Gamestack.CONTEXT_MENU) {
        ...
        window.setTimeout(function(){
            ...
            $('#object-builder').contextMenu(__rightClickInterfaceOnSelectedObject, {triggerOn: 'contextmenu'});
